...
export const getProcessingSummary = () => request("/api/ingestion/processing-summary");
export const processTelemetry = (limit = 500) => request(`/api/ingestion/process?limit=${limit}`, { method: "POST" });
